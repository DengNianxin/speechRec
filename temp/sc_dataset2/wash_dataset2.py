...
if __name__ == "__main__":
    # 定义文件路径
    wash_by_label_dev = "wash_by_label_dev.txt"
    wash_by_label_train = "wash_by_label_train.txt"
    wash_by_duration_dev = "wash_by_duration_dev.txt"
    wash_by_duration_train = "wash_by_duration_train.txt"
    wash_special = "wash_special.txt"
    ...
    # 读取需要删除的文件名
    print("读取开发集文件...")
    wash_by_label_dev_file_names = read_file_names(wash_by_label_dev)
    wash_by_duration_dev_file_names = read_file_names(wash_by_duration_dev)
    wash_special_file_name = read_file_names(wash_special)
    dev_file_names = wash_by_label_dev_file_names.union(wash_by_duration_dev_file_names).union(wash_special_file_name)

    print("读取训练集文件...")
    wash_by_label_train_file_names = read_file_names(wash_by_label_train)
    wash_by_duration_train_file_names = read_file_names(wash_by_duration_train)
    wash_special_file_name = read_file_names(wash_special)
    train_file_names = wash_by_label_train_file_names.union(wash_by_duration_train_file_names).union(wash_special_file_name)
